...
- Scan captions use compact icon sections for token stats, socials, audit, and calls, with categorized button menus for charts, X links, security, socials, and trade tools. The trade menu includes OgreTradeBot.
